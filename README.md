...
项目采用多分支开发模式，以平衡稳定性和创新：

*   **`main` (稳定版)**：
    *   该分支经过充分测试，功能稳定可靠。
    *   推荐大多数用户及日常学习使用。
*   **`experimental` (开发/实验版)**：
    *   **版本更加超前**：包含最新开发的特性和底层优化。
    *   **前沿技术尝试**：实验性功能（如预测性返回手势优化、UI 布局重构等）会优先在此分支上线。
    *   *注意：实验性分支可能存在不稳定性，欢迎开发者测试并反馈。*
...
*   **🎨 优雅的 UI/UX 设计**：
    ...
    *   **预测性返回 (Predictive Back)**：支持 Android 14+ 系统的预测性返回手势，操作更丝滑（Experimental 分支）。
